  ...
  module News
    module ItemsHelper
      def news_item_archive_widget
        items = Refinery::News::Item.select('publish_date')
      ...
      def news_item_archive_links
        html = ''
        item_months = ::Refinery::News::Item.all.group_by {|i| i.publish_date.beginning_of_month}
      ...
      def month_translation(post_date)
        post_date = post_date.strftime('%m/%Y')
