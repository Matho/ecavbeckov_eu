...
Refinery::Core.configure do |config|
  ...
  # Site name
   config.site_name = "Cirkevný zbor ECAV Beckov"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  # config.google_analytics_page_code = "YOUR_CUSTOM_GANALYTICS_CODE"
  ...
  # config.dragonfly_secret = "YOUR_CUSTOM_DRAGONFLY_SECRET"
  ...
  # config.register_stylesheet "custom", :media => 'screen'
    config.register_stylesheet "videojs/tubecss-skin"
end
